...
from product.views import show_product_page, show_product_detail, add_product, delete_product, search_products, show_xml, show_json, show_json_by_id, show_xml_by_id
