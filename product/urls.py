...
from product.views import show_product_page, show_product_detail, edit_product, add_product, delete_product, show_xml, show_json, show_json_by_id, show_xml_by_id, add_product_flutter, delete_product_flutter
